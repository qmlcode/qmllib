...
from qmllib.representations import generate_acsf, generate_fchl_acsf
...
def get_acsf_numgrad(mol, dx=1e-5):
    ...
    true_rep = generate_acsf(mol.nuclear_charges, mol.coordinates, gradients=False, **REP_PARAMS)
...
def test_acsf():
    ...
    repb = generate_acsf(mol.nuclear_charges, mol.coordinates, gradients=False, **REP_PARAMS)
