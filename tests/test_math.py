...
def test_cho_solve():
    ...
    A = deepcopy(A_ref) 
    y = deepcopy(y_ref) 
    x_qml   = qmllib.ml.math.cho_solve(A,y)
...
def test_cho_invert():
    ...
    A = deepcopy(A_ref) 
    Ai_qml = qmllib.ml.math.cho_invert(A)
...
def test_bkf_invert():
    ...
    A = deepcopy(A_ref) 
    Ai_qml = qmllib.ml.math.bkf_invert(A)
...
def test_bkf_solve():
    ...
    A = deepcopy(A_ref) 
    y = deepcopy(y_ref)
    x_qml   = qmllib.ml.math.bkf_solve(A,y)
